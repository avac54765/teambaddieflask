...
def initISPEs():
    with app.app_context():
        ...
        i1 = ISPE(name2='Alexa Carlson', id='alexa', duration2='2', date2=date(2006, 5, 16), grade='A')
        i2 = ISPE(name2='Ava Carlson', id='ava')
        i3 = ISPE(name2='Tom Holland', id='tommy', duration2='3', date2=date(1996, 6, 1), grade='B')
        i4 = ISPE(name2='Dylan Obrien', id='dylan', duration2='4', date2=date(1991, 8, 26), grade='D')
        i5 = ISPE(name2='John Mortensen', id='jm1021', duration2='1', date2=date(1959, 10, 21), grade='A')
